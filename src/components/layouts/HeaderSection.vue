...
<template>
  <!-- this header -->
  <header class="bg-white dark:bg-gray-800 p-2 border-b-2 dark:border-gray-700 relative z-[10]">
    <div class="wrap-header flex items-center justify-between flex-wrap">
      <div class="flex flex-no-shrink items-center">
        ...
        <h2
          class="text-md text-indigo-800 ml-3 lg:block hidden px-5 p-2 rounded-md "
        >
...
<!--            ></path>-->
        ...
        <button @click="menuToggle" @blur="menuToggleBlur">
          ...
          >
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTECed5LoZ4oQR3-3uEUxk0E9HifE17iG-aDQ&usqp=CAU"
        ...
        <transition name="fade">
          ...
          >
            <div class="py-3 text-center font-bold text-md px-4  text-gray-900 dark:text-gray-200">
              <div class="truncate"> Admin </div>
            </div>

            <div @click="logout" class="py-1 text-center">
              <a
                href="#"
